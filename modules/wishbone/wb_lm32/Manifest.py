...
elif (target == "xilinx" and syn_device[0:4].upper()=="XC6V"): # Virtex6
	files.extend(["platform/generic/lm32_multiplier.v", "platform/virtex6/jtag_tap.v"]) # use generic multipier for now
else:
